 ...
 */
public class MotionTrackingActivity extends CardboardActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCardboardView.setEGLContextClientVersion(2);
...
/* this didn't work
        ...
        Log.e(TAG, params.getWidth() + "," + params.getHeight());
        params.setWidth(1920);
        params.setHeight(1200);
        mCardboardView.updateScreenParams(params);
*/

        ScreenParams screenParams = new ScreenParams(getWindowManager().getDefaultDisplay());
        mCardboardView.updateScreenParams(screenParams);
